...
# Form implementation generated from reading ui file 'update_client.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.pushButtonSaveCl = QtWidgets.QPushButton(self.groupBox)
        self.pushButtonSaveCl.setObjectName("pushButtonSaveCl")
        self.verticalLayout_2.addWidget(self.pushButtonSaveCl)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBox.setTitle(_translate("Dialog", "Изменение клиента"))
        ...
        self.pushButtonSaveCl.setText(_translate("Dialog", "Сохранить"))
